<?php // PLUGIN EMAIL SUPPORT FORM - Mitchell Bennis | Element Engage, LLC | 
	...
	// #eeSupportForm, eeContact - Rev 03.19
...
$eeRSCF_Log[] = 'Loaded: ee-plugin-support';
	
// Config		
$eeContact_To = 'support@elementengage.com';
...
$eeOutput .= '<article class="eeSupp">
		...
		<form action="' . $eeContact_Location . '" method="post" id="eeSupportForm">
			...
			<fieldset>
				...
				<p style="text-align:right;"><i>' . __('Plugin environment details will automatically be sent along with your message to:', 'ee-simple-file-list') . '</i><br />
